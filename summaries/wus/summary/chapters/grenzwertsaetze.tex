...
\begin{tcolorbox}
    \textbf{Gesetz der grossen Zahlen} \smallskip
...
\Satz \textbf{Konvergenz in Verteilung}: Seien $(X_n)_{n \in \N}$ und $X$ ZV. Wir schreiben
...
\begin{tcolorbox}
    \textbf{Zentraler Grenzwertsatz} \smallskip
    ...
    \textbf{Achtung}: $m$ und $\sigma^2$ kommen von $X_1$ und nicht von $S_n$!
\end{tcolorbox}

Der Zentrale Grenzwertsatz besagt, dass die Verteilung einer ZV
$$Z_n = \frac{S_n - n \cdot m}{\sqrt{\sigma^2 \cdot n}} = \frac{\frac{1}{n} S_n - m}{\frac{\sigma}{\sqrt n}}$$
