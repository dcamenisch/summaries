...
\Satz \textbf{Monotonie}: Seien $X,Y$ ZV sodass $X \leq Y$ f.s. dann gilt $\E[X] \leq \E[Y]$. \smallskip

\begin{tcolorbox}
    \textbf{Markov Ungleichung} \smallskip 
...
\begin{tcolorbox}
    \textbf{Jensen Ungleichung} \smallskip 
...
\begin{tcolorbox}
    \textbf{Chebychev Ungleichung} \smallskip
...
$X,Y$ unabhängig impliziert Cov$[X,Y] = 0$, aber nicht andersherum! Eine Ausnahme ist die 2-dim Normalverteilung, hier gilt die Implikation in beide Richtungen.
