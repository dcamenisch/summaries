...
\ifthenelse{\lengthtest { \paperwidth = 11in}}
	...
	{\ifthenelse{ \lengthtest{ \paperwidth = 297mm}}
		{\geometry{top=1cm,left=1cm,right=1cm,bottom=1.1cm} }
...
\newcommand\Title[1]{\begin{tikzpicture} \node[fancytitle, right=10pt, fill=black] {#1}; \end{tikzpicture}}

\scriptsize

% _____ BEGINNING OF DOCUMENT __________________________________________________
\input{chapters/reelle-zahlen.tex}
\input{chapters/folgen-reihen.tex}
\input{chapters/stetigkeit.tex}
\input{chapters/differenzierbarkeit.tex}
\input{chapters/integrale.tex}
...
%
% Content: 
% original by Danny Camenisch (dcamenisch@student.ethz.ch), 2021
% based on different summarys from many helpfull people
